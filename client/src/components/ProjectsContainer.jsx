...
export default function Projects(props) {
    ...
    return (
        <div className="projects">
            <Card classAdd="hero" img={logo} title="FiveInfo" link="https://github.com/lukasz26671/FiveInfo">
                Applicaton that displays info about given FiveM server

                <p>Note: GitRepo is private atm.</p>
            </Card>
            <Card classAdd="hero" img={mydb} title="MyDB">
                A mysql / mongodb wrapper for node.js

                <p><b>IN CONSTRUCTION</b></p>
            </Card>
            <Card classAdd="hero" img={exocraft} title="Exocraft" link="https://github.com/lukasz26671/Exocraft">
                Next-gen minecraft mod that expands your modding experience with support for many mods!
                
                <p>Note: GitRepo is private atm.</p>
            </Card>
            <Card classAdd="hero" img={logo} title="This webpage" link="https://github.com/lukasz26671/DLZStudiosWebpage">
